...
MAINTAINER Waret <lishouchao@beyondcent.com>
...
LABEL io.k8s.description="Platform for building and running Java applications on Apache-Tomcat ${TOMCAT_VERSION}" \
          io.k8s.display-name="Apache-Tomcat ${TOMCAT_VERSION}" \
          io.openshift.expose-services="8080:http" \
          io.openshift.tags="builder,tomcat,tomcat${TOMCAT_DISPLAY_VERSION}" \
